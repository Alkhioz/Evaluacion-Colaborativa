...
### Donde:
\
![equation](http://latex.codecogs.com/gif.latex?%20\begin{cases}%20y=m%20&\hbox{cuando%20}%20(x-(0.05m))%3C=%20w%20%3C=%20(x+(0.05m))%20&%20y=m*0.9%20&\hbox{cuando%20}%20(x-(0.15m))%3C=%20w%20%3C=%20(x+(0.15m))%20&%20y=m*0.6%20&\hbox{cuando%20}%20(x-(0.25m))%3C=%20w%20%3C=%20(x+(0.25m))%20&%20y=m*0.5%20&\hbox{cuando%20}%20(x-(0.35m))%3C=%20w%20%3C=%20(x+(0.35m))%20&%20y=m*0.4%20&\hbox{cuando%20}%20(x-(0.45m))%3C=%20w%20%3C=%20(x+(0.45m))%20&%20y=m*0.2%20&\hbox{cuando%20}%20(x-(0.46m))%3C=%20w%20%3C=%20(x+(0.46*m))%20&\end{cases})
